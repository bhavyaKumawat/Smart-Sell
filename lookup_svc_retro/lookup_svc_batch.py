...
from lookup_svc_retro.lookup_send_messages_and_errors import lookup_send_message_to_queue
from lookup_svc_retro.process_sm_lookup import sm_lookup
                    ...
                    async for msg in receiver:
                        try:
                            ...
                            if sm:
                                ...
                                await lookup_send_message_to_queue(results, sm)
